...
namespace TelephoneDirectory.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TelephoneDirectoryConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(TelephoneDirectoryDbContext context)
        {
            _context = context;
        }
