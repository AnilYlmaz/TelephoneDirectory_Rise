...
namespace TelephoneDirectory.Migrations
{
    ...
    [Migration("20210928130737_Initial_Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelephoneDirectory.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TelephoneDirectory.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TelephoneDirectory.Models.Members", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AbpMembers");
                });

            modelBuilder.Entity("TelephoneDirectory.Models.MembersContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AbpMembersContact");
                });

            modelBuilder.Entity("TelephoneDirectory.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TelephoneDirectory.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TelephoneDirectory.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TelephoneDirectory.Authorization.Roles.Role", b =>
                {
                    b.HasOne("TelephoneDirectory.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("TelephoneDirectory.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("TelephoneDirectory.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TelephoneDirectory.Models.MembersContact", b =>
                {
                    b.HasOne("TelephoneDirectory.Models.Members", "Members")
                        .WithMany()
