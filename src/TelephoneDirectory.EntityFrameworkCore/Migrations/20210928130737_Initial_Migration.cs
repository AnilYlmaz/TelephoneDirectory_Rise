    ...
    public partial class Initial_Migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpMembers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpMembersContact", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AbpMembersContact_AbpMembers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AbpMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpMembersContact_MemberId",
